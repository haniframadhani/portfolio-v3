...
<template>
  <section id="home" class="grid content-center h-dvh-minus-header">
    <div
    ...
    <div class="flex h-11 md:h-16 font-display text-3xl md:text-5xl font-black overflow-hidden">
      <h1>I Build&nbsp;</h1>
      <span
        class="flex flex-col w-fit gap-1"
        :class="allowAnimation && `transition-transform duration-300 ease-in-out`"
    ...
    <h2 class="text-2xl md:text-4xl font-display font-medium">More than just a website</h2>
